...
public class CoreStatusMotivationIntroActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_core_status_motivation_intro);
        ...
        SECTION_ID = "CS";
        activeActivity = 3;
        set(CoreStatusMotivationIntroActivity.this);

        CommonFunctions.updateLeftView(m_context, "CSM", 1);

        relativeLayout = (RelativeLayout) findViewById(R.id.relativeLayoutCoreStatus);
        relativeLayout.startAnimation(AnimationUtils.loadAnimation(CoreStatusMotivationIntroActivity.this, R.anim.fadein));

        findViewById(R.id.imageViewNext).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(CoreStatusMotivationIntroActivity.this, CoreStatusMotivationQuizActivity.class);
                startActivity(i);
                //finish();
                // close this activity
            ...
            if(action == 1) {
                ...
                if(currentIdentity == nextIdentity) {
                    if(SECTION.equals("CSS")) {
                        Intent i = new Intent(CoreStatusMotivationIntroActivity.this,CoreStatusHappinessIntroActivity.class);
                        startActivity(i);
                        finish();
                        overridePendingTransition(R.anim.abc_fade_in, R.anim.abc_fade_out);
        ...
        try {
            ...
            for(final Question question : questionList) {
                ...
                ((ImageView) layoutQuestionItem.findViewById(R.id.imageViewQuestion)).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        final Dialog dialog = new Dialog(CoreStatusMotivationIntroActivity.this);
