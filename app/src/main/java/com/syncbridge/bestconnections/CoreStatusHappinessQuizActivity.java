...
public class CoreStatusHappinessQuizActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_core_status_happiness_quiz);
        ...
        SECTION_ID = "CS";
        activeActivity = 3;
        set(CoreStatusHappinessQuizActivity.this);

        CommonFunctions.updateLeftView(m_context, "CSH", 5);
        ...
        findViewById(R.id.imageViewNext).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(CoreStatusHappinessQuizActivity.this, CoreStatusHappinessResultActivity.class);
    ...
    private View handleQuiz() {
        ...
        try {
            ...
            List<Quiz> quizList = quizDataSource.getAllEntries("CSH");
