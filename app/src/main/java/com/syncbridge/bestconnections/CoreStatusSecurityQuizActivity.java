...
public class CoreStatusSecurityQuizActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_core_status_security_quiz);
        ...
        if(!lastQuoteId.isEmpty()) {
            ...
            try {
                ...
                for(Quiz q : quizDataSource.getAllEntries("CSS")) {
                    result += q.getValue();
                }
            } catch (SQLException e) {
                e.printStackTrace();
            }
            Intent i = new Intent(CoreStatusSecurityQuizActivity.this, CoreStatusSecurityResultActivity.class);
        ...
        SECTION_ID = "CS";
        activeActivity = 3;
        set(CoreStatusSecurityQuizActivity.this);

        CommonFunctions.updateLeftView(m_context, "CSS", 5);
    ...
    private View handleQuiz() {
        ...
        try {
            ...
            List<Quiz> quizList = quizDataSource.getAllEntries("CSS");
