...
public class ResourcesClose1Activity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resources_close1);
        ...
        findViewById(R.id.imageViewNext).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(ResourcesClose1Activity.this,ResourcesClose2Activity.class);
                startActivity(i);
                //finish();
                // close this activity
