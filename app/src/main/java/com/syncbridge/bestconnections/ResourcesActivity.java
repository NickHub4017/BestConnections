...
public class ResourcesActivity extends MainActivity {
    ...
    private CircularImageView imageViewCartoon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout = (RelativeLayout) findViewById(R.id.relativeLayoutResources);
        ...
        imageViewCartoon = (CircularImageView) findViewById(R.id.imageViewCartoon);
        ...
        try {
            ...
            quoteList = quoteDataSource.getAllEntries("RS");
        ...
        if(currentIdentity.isEmpty()) {
            ...
            if(action == 1) {
                ...
                if(currentIdentity == nextIdentity) {
                    Intent i = new Intent(ResourcesActivity.this, ResourcesQuizActivity.class);
                    startActivity(i);
    ...
    private View loadQuestionControl(final Quote quote) {
        ...
        try {
            ...
            for(final Question question : questionList) {
                ...
                ((TextView)layoutQuestionItem.findViewById(R.id.textViewQuestion)).setText(
                        CommonFunctions.getSpannableStringBuilder(m_context, question.getQuestion()), TextView.BufferType.SPANNABLE);


                ((ImageView) layoutQuestionItem.findViewById(R.id.imageViewQuestion)).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        final Dialog dialog = new Dialog(ResourcesActivity.this);
