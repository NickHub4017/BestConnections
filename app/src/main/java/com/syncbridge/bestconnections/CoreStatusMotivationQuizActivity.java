...
public class CoreStatusMotivationQuizActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_core_status_motivation_quiz);
        ...
        SECTION_ID = "CS";
        activeActivity = 3;
        set(CoreStatusMotivationQuizActivity.this);

        CommonFunctions.updateLeftView(m_context, "CSM", 5);
        ...
        findViewById(R.id.imageViewNext).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(CoreStatusMotivationQuizActivity.this, CoreStatusMotivationResultActivity.class);
    ...
    private View handleQuiz() {
        ...
        try {
            ...
            List<Quiz> quizList = quizDataSource.getAllEntries("CSM");
